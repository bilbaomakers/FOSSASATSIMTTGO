...
void setup() {
  ...
  Timer1.attach(MODEM_SWITCHING_PERIOD_FSK,Communication_Change_Modem);
  ...
  if(switchModem) {
    ...
    switch(currentModem) {
      case MODEM_FSK_NON_ISM:
        ...
        Timer1.attach(MODEM_SWITCHING_PERIOD_LORA_ISM,Communication_Change_Modem);
        break;
      case MODEM_LORA_ISM:
        currentModem = MODEM_LORA_NON_ISM;
        //Timer1.setPeriod(MODEM_SWITCHING_PERIOD_LORA_NON_ISM);
        Timer1.attach(MODEM_SWITCHING_PERIOD_LORA_NON_ISM,Communication_Change_Modem);
        break;
